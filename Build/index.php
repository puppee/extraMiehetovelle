...
<html lang="fi" xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://ogp.me/ns/fb#">
  <head>
    ...
    <meta property="og:image" content="http://byts.fi/miehetovelle/byts.jpg" />
    <meta property="og:title" content="MOC Extranet (ByTS EX)" />
    <link rel="stylesheet" href="http://cdn.byts.fi/bootstrap/3.3.6/css/bootstrap.min.css">
    ...
    <![endif]-->
	<script src="http://cdn.byts.fi/angularjs/1.5.0/angular.min.js"></script> <! Sisällytä mukaan, ei CDN:ää.>
    <script>
  ...
  <body class="hold-transition skin-blue sidebar-mini" ng-app="miehetovelle">
    <div class="wrapper" ng-controller="main">
      ...
      <header class="main-header">
        <a href="index.php" class="current logo">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li class='current'><a class='current' href="index.php"><i class="fa fa-dashboard"></i> Etusivu</a></li>
